 ...
 * Generated for Laravel 5.5.40 on 2018-04-03 14:11:28.
 *
...
namespace Services\Bio { 
    ...
    class BioFacade {
        ...
        {
            return \Services\Bio\BioService::getBio($bio);
        }
         ...
         * @static 
         */ 
        public static function createDefault($member_id)
        {
            return \Services\Bio\BioService::createDefault($member_id);
        }
...
namespace Services\Location { 
    ...
    class LocationFacade {
        ...
        {
            return \Services\Location\LocationService::getLocation($location);
        }
        ...
        {
            return \Services\Location\LocationService::createDefault();
        }
...
namespace Services\Residence { 
    ...
    class ResidenceFacade {
         ...
         * @static 
         */ 
        public static function getResidence($residence)
        {
            return \Services\Residence\ResidenceService::getResidence($residence);
        }
         ...
         * @static 
         */ 
        public static function getResidences($member_id)
        {
            return \Services\Residence\ResidenceService::getResidences($member_id);
        }
         ...
         * @static 
         */ 
        public static function getActive($member_id)
        {
            return \Services\Residence\ResidenceService::getActive($member_id);
        }
         ...
         * @static 
         */ 
        public static function getInactive($member_id)
        {
            return \Services\Residence\ResidenceService::getInactive($member_id);
        }
...
namespace Services\Status { 
    ...
    class StatusFacade {
        ...
        {
            return \Services\Status\StatusService::getStatus($status);
        }
...
namespace Services\Study { 
    ...
    class StudyFacade {
        ...
        {
            return \Services\Study\StudyService::getStudy($study);
        }
         ...
         * @static 
         */ 
        public static function getStudies($member_id)
        {
            return \Services\Study\StudyService::getStudies($member_id);
        }
        ...
        public static function getActive($member_id)
        {
            return \Services\Study\StudyService::getActive($member_id);
        }
        ...
        public static function getInactive($member_id)
        {
            return \Services\Study\StudyService::getInactive($member_id);
        }
...
namespace Services\TimeAndPlace { 
    ...
    class TimeAndPlaceFacade {
         ...
         * @static 
         */ 
        public static function getTimeAndPlace($timeAndPlace)
        {
            return \Services\TimeAndPlace\TimeAndPlaceService::getTimeAndPlace($timeAndPlace);
        }
        ...
        public static function createDefault()
        {
            return \Services\TimeAndPlace\TimeAndPlaceService::createDefault();
        }
...
namespace Services\Workplace { 
    ...
    class WorkplaceFacade {
         ...
         * @static 
         */ 
        public static function getWorkplace($workplace)
        {
            return \Services\Workplace\WorkplaceService::getWorkplace($workplace);
        }
         ...
         * @static 
         */ 
        public static function getWorkplaces($member_id)
        {
            return \Services\Workplace\WorkplaceService::getWorkplaces($member_id);
        }
        ...
        public static function getActive($member_id)
        {
            return \Services\Workplace\WorkplaceService::getActive($member_id);
        }
        ...
        public static function getInactive($member_id)
        {
            return \Services\Workplace\WorkplaceService::getInactive($member_id);
        }
...
namespace  { 
    ...
    class Bio extends \Services\Bio\BioFacade {}

    class Location extends \Services\Location\LocationFacade {}

    class Residence extends \Services\Residence\ResidenceFacade {}

    class Status extends \Services\Status\StatusFacade {}

    class Study extends \Services\Study\StudyFacade {}

    class TimeAndPlace extends \Services\TimeAndPlace\TimeAndPlaceFacade {}

    class Workplace extends \Services\Workplace\WorkplaceFacade {}
